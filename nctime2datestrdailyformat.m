%  Does not work for data with Months since time units
%
%

function [ncdates]=nctime2datestrdailyformat(times,units,formatOut)
    ...
    ncdates=datestr(timetmp+startDateInfo,formatOut);
